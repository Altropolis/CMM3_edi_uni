# This is the same as  euler_implicit.py except it has the secant method imported from a file.
# Often, it is useful to reuse some functions in multiple codes. In this case it is conveneient to
# save the function in a separate file and import this file in our main code.
